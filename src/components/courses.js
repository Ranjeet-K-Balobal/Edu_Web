      ...
      <div class="container" style={{ marginTop: "100px" }}>
        <div class="row">
          ...
          <div class="col">
            <div class="card" style={{ width: "18rem" }}>
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMmLxgqUg1e6GjKJwsGu7V_7774u2txlUprQ&usqp=CAU"
                alt="nothing"
              ></img>
              <div class="card-body">
          ...
          <div class="col">
            <div class="card" style={{ width: "18rem" }}>
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBuM0cKT-0QOfhJd0OelvqbamCwIC6W17u2Q&usqp=CAU"
                class="card-img-top"
                alt="nothing"
              ></img>
              <div class="card-body">
